...
const aplicacion = 
{
    ...
    crearMarcador: function(mapa) 
    {
        var icono = 
        {
            url: 'http://icons.iconarchive.com/icons/icons-land/vista-map-markers/128/Map-Marker-Marker-Outside-Pink-icon.png',
    ...
    {
        let origen = new google.maps.LatLng(aplicacion.elemento.latitud, aplicacion.elemento.longitud);
